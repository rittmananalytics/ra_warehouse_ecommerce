...
channel_mapped as (
    ...
    select
      mapped.*,
      case when marketing_channel_mapping.channel is not null then marketing_channel_mapping.channel
           when marketing_channel_mapping.channel is null and mapped.referrer_host is not null then 'Referral'
