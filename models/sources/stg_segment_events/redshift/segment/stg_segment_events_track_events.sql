...
renamed as (
    ...
    select
        ...
        lower(context_campaign_term)       as utm_term,
        lower(context_campaign_content)    as utm_content,
        lower(context_campaign_medium)     as utm_medium,
        lower(context_campaign_name)       as utm_campaign,
        lower(context_campaign_source)     as utm_source,
        context_ip                  as ip,
